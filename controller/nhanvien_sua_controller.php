<?php
    ...
    $sql_Sua_User = "UPDATE account as a, staff as s SET s.first_name = '$u_fn', s.last_name = '$u_ln', s.dob = '$u_dob', a.email = '$u_email', a.username = '$u_user', a.role = '$u_role', a.isActive = '$u_isActive' WHERE a.id = s.staff_id AND id ='$u_id'";
    // write log
