...
<head>
    ...
    <title>Quản Lý Thiết Bị Phòng Gym - Dashboard</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="activity_log.html">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            echo "<div class='h5 mb-0 font-weight-bold text-gray-800'>" .$row["COUNT(eq_id)"] ."</div>";
                                            }
                                            ?>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Chất Lượng Thiết Bị
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
